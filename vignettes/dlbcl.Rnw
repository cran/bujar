...
E-mail: \email{wangz1@uthscsa.edu}
}
...
%%% for Short version, latex context between lines of \iffalse and \fi are skipped. But for Long version and to generate figures, comment out \iffalse and \fi
\iffalse

\begin{figure}[htbp!]
\centering
\subfloat[]{
<<label=int1, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
...
\qquad
\subfloat[]{
<<label=int2, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
...
\\
\subfloat[]{
<<label=int3, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
...
\qquad
\subfloat[]{
<<label=int4, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
...
\\
\subfloat[]{
<<label=int5, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
...
\qquad
\subfloat[]{
<<label=int6, fig=TRUE, echo=FALSE, include=FALSE, eval=F>>=
